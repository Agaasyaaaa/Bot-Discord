...
async def artikel(ctx):
    ...
    if artikel == 1:
        ...
        await ctx.send(f"https://www.who.int/health-topics/air-pollution#tab=tab_1")
    elif artikel == 3:
        await ctx.send(f"https://www.detik.com/edu/detikpedia/d-6994289/pencemaran-udara-pengertian-penyebab-dampak-dan-contohnya")
